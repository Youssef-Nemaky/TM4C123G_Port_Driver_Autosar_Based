...
const Port_ConfigType Port_Configuration = {
    ...
    PORT_A, PORT_A_PIN_4, PORT_PIN_IN, PORT_MODE_0, OFF, STD_LOW, changeable, changeable,
    PORT_A, PORT_A_PIN_5, PORT_PIN_IN, PORT_MODE_0, OFF, STD_LOW, changeable, changeable,
    PORT_A, PORT_A_PIN_6, PORT_PIN_IN, PORT_MODE_0, OFF, STD_LOW, changeable, changeable,
    PORT_A, PORT_A_PIN_7, PORT_PIN_IN, PORT_MODE_0, OFF, STD_LOW, changeable, changeable,

    /* PORT B pins*/
    PORT_B, PORT_B_PIN_0, PORT_PIN_IN, PORT_MODE_0, OFF, STD_LOW, changeable, changeable,
    PORT_B, PORT_B_PIN_1, PORT_PIN_IN, PORT_MODE_0, OFF, STD_LOW, changeable, changeable,
    PORT_B, PORT_B_PIN_2, PORT_PIN_IN, PORT_MODE_0, OFF, STD_LOW, changeable, changeable,
    PORT_B, PORT_B_PIN_3, PORT_PIN_IN, PORT_MODE_0, OFF, STD_LOW, changeable, changeable,
    PORT_B, PORT_B_PIN_4, PORT_PIN_IN, PORT_MODE_0, OFF, STD_LOW, changeable, changeable,
    PORT_B, PORT_B_PIN_5, PORT_PIN_IN, PORT_MODE_0, OFF, STD_LOW, changeable, changeable,
    PORT_B, PORT_B_PIN_6, PORT_PIN_IN, PORT_MODE_0, OFF, STD_LOW, changeable, changeable,
    PORT_B, PORT_B_PIN_7, PORT_PIN_IN, PORT_MODE_0, OFF, STD_LOW, changeable, changeable,
    
    /* PORT C pins*/
    PORT_C, PORT_C_PIN_0, PORT_PIN_IN, PORT_MODE_0, OFF, STD_LOW, changeable, changeable,
    ...
    PORT_E, PORT_E_PIN_1, PORT_PIN_IN, PORT_MODE_0, OFF, STD_LOW, changeable, changeable,
    PORT_E, PORT_E_PIN_2, PORT_PIN_IN, PORT_MODE_0, OFF, STD_LOW, changeable, changeable,
    PORT_E, PORT_E_PIN_3, PORT_PIN_IN, PORT_MODE_0, OFF, STD_LOW, changeable, changeable,
    PORT_E, PORT_E_PIN_4, PORT_PIN_IN, PORT_MODE_0, OFF, STD_LOW, changeable, changeable,
    PORT_E, PORT_E_PIN_5, PORT_PIN_IN, PORT_MODE_0, OFF, STD_LOW, changeable, changeable,
